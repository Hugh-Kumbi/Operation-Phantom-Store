...
| Vertex | Version 1.0 | Version 1.1 |
|----------------|------------|------------|
| Adversary      | Recruiter-led contact                | No change                                               |
| Infrastructure | 3 observed domains                   | 5 observed domains                                      |
| Capability     | Social engineering, onboarding       | Added platform migration and replacement infrastructure |
| Victim         | Investigator / Job seekers           | Expanded evidence set through continued engagement      |
