...
| Version | Date | Change |
|---------|------|--------|
| 2.0 | 2026-09-24 | Added IoCs for `unitelmatch.cc` and `unitelmatch.cyou`; added shared backend indicators (`www.ioutrankap.cyou`); added API endpoint indicators; added HTTP header indicators; expanded network and behavioural indicators; and updated campaign infrastructure relationships. |
